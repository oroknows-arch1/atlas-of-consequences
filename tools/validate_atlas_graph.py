...
for node_id in edition.get("node_state", {}):
...
if edition.get("foreground_next") != "visual_character_bible":
    errors.append("AOC-001 foreground must currently be visual_character_bible")
